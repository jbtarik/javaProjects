...
public class GossipsShould {
    ...
    public void bePropagatedByAnyMister() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Mr Black", "Titles.Mr Blue")
                .from("White").to("Black")
                .from("Black").to("Blue");
    ...
    public void beRememberedByDoctors() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Mr Black", "Titles.Dr Brown", "Titles.Mr Pink")
                .from("White").to("Brown")
                .from("Black").to("Brown")
                .from("Brown").to("Pink");
    ...
    public void alwaysBeListenedByAnAgent() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Mr Grey", "Titles.Agent Pink","Titles.Mr Blue")
                .from("White").to("Pink")
                .from("Grey").to("Pink")
                .from("Pink").to("Blue");
    ...
    public void beStoppedByAnAgent() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Agent Pink","Titles.Mr Blue")
                .from("White").to("Pink")
                .from("Pink").to("Blue");
    ...
    public void beDelayedOneTurnByAProfessor() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Pr Pink", "Titles.Mr Blue")
                .from("White").to("Pink")
                .from("Pink").to("Blue");
...
//
    ...
    public void bePropagatedByALadyWhenComingFromADoctor() {
        ...
        Gossips gossips = new Gossips("Titles.Dr Black", "Titles.Lady Green", "Titles.Agent Pink")
                .from("Black").to("Green")
                .from("Green").to("Pink");
    ...
    public void notBePropagatedByALadyWhenComingAMister() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Lady Green", "Titles.Agent Pink")
                .from("White").to("Green")
                .from("Green").to("Pink");
    ...
    public void beReturnedAndInvertedByGentlemen() {
        ...
        Gossips gossips = new Gossips("Titles.Mr White", "Titles.Sir Rose", "Titles.Mr Black")
                .from("White").to("Rose")
                .from("Rose").to("Black");
